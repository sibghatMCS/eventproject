...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'dropdown_a'); ?>
		<?php echo $form->textField($model,'dropdown_a'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'dropdown_b'); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'qr_code',array('size'=>60,'maxlength'=>400)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'key'); ?>
		<?php echo $form->textField($model,'key',array('size'=>60,'maxlength'=>400)); ?>
	</div>
