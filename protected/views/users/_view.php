...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dropdown_a')); ?>:</b>
	<?php echo CHtml::encode($data->dropdown_a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('dropdown_b')); ?>:</b>
	<?php echo CHtml::encode($data->dropdown_b); ?>
	<br />
