 ...
 * @property integer $dropdown_a
 * @property integer $dropdown_b
...
class Users extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => 'Name',
			'email' => 'Email',
			'dropdown_a' => 'Dropdown A',
			'dropdown_b' => 'Dropdown B',
			'mobile_no' => 'Mobile No',
			'qr_code' => 'Qr Code',
			'key' => 'Key',
			'status' => 'Status',
...
/**
	...
	public function search()
	{
		...
		$criteria->compare('dropdown_a',$this->dropdown_a);
		$criteria->compare('dropdown_b',$this->dropdown_b);
